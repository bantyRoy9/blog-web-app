...
var Security = function Security(_ref) {
  ...
  var _React$useState3 = React__namespace.useState(function () {
    ...
    return majorVersion;
      ...
      _React$useState4 = _slicedToArray__default['default'](_React$useState3, 1),
  ...
  React__namespace.useEffect(function () {
    ...
    if (oktaAuth._oktaUserAgent) {
      oktaAuth._oktaUserAgent.addEnvironment("@okta/okta-react".concat("/", "6.3.0"));
    } else {
  ...
  if (oktaAuthMajorVersion !== "5" && process.env.SKIP_VERSION_CHECK !== '1') {
    var _err2 = new oktaAuthJs.AuthSdkError("Passed in oktaAuth is not compatible with the SDK, okta-auth-js version ".concat("5", ".x is the current supported version."));
